...
export const productsDetail: ProductDetail[] = [
  {
    ...
    default_price: "59.90",
    default_stock: 0,
    main_image: "http://127.0.0.1:8000/media/products/bte.jpg",
    images: [
      {
        id: 4,
        product: 1,
        image: "http://127.0.0.1:8000/media/products/bte.jpg",
        position: 0,
      },
    ],
    variants: [
  ...
  },
  {
    ...
    default_stock: 0,
    main_image: "http://127.0.0.1:8000/media/products/zun.jpg",
    images: [
      {
        id: 3,
        product: 2,
  ...
  },
  {
    ...
    default_price: "49.90",
    default_stock: 0,
    main_image: "http://127.0.0.1:8000/media/products/cbb.png",
    images: [
      {
        id: 2,
        product: 4,
  ...
  },
  {
    ...
    default_stock: 0,
    main_image: "http://127.0.0.1:8000/media/products/clb.jpg",
    images: [
      {
        id: 1,
        product: 5,
  ...
  },
  {
    ...
    default_stock: 0,
    main_image: "http://127.0.0.1:8000/media/products/zcb1.jpeg",
    images: [
      {
        id: 5,
        product: 7,
      ...
      },
      {
        id: 6,
        product: 7,
        image: "http://127.0.0.1:8000/media/products/zcb2.webp",
        position: 1,
      },
      {
        id: 7,
        product: 7,
        image: "http://127.0.0.1:8000/media/products/zcb3.webp",
        position: 2,
      },
      {
        id: 8,
        product: 7,
        image: "http://127.0.0.1:8000/media/products/zcb4.webp",
        position: 3,
      },
      {
        id: 9,
        product: 7,
        image: "http://127.0.0.1:8000/media/products/zcb5.webp",
        position: 4,
      },
    ],
    variants: [
